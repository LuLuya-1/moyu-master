...
const WORK_CARDS = [
  ...
  { id: "w5", type: "work", title: "向上管理", cost: 1, performance: 1, points: 2, suspicion: -1, text: "+1 业绩，+2 分，风险值 -1", flavor: "同步得及时，结果就显得及时。" },
  ...
  { id: "w11", type: "work", title: "项目交付", cost: 2, performance: 4, points: 2, text: "+4 业绩，+2 分", flavor: "压线交付也是一种准时。" },
  { id: "w12", type: "work", title: "替同事顶班", cost: 2, performance: 4, suspicion: -2, text: "+4 业绩，风险值 -2", flavor: "人情记在账上，班记在你头上。" },
];
...
const GROWTH_CARDS = [
  { id: "gs1", type: "growth", growthType: "skill", growthLabel: "技能", title: "快捷键修炼", cost: 1, performance: 1, text: "技能；+1 业绩", flavor: "省下的每一秒都可以用来发呆。" },
  ...
  { id: "gs5", type: "growth", growthType: "skill", growthLabel: "技能", title: "写作训练", cost: 1, text: "技能；无即时效果", flavor: "先把废话写顺，再把废话删掉。" },
  { id: "gs6", type: "growth", growthType: "skill", growthLabel: "技能", title: "专业认证", cost: 2, performance: 2, text: "技能；+2 业绩", flavor: "证书不能解决问题，但能装进附件。" },

  { id: "ge1", type: "growth", growthType: "efficiency", growthLabel: "效率", title: "时间管理", cost: 2, energy: 1, text: "效率；返还 1 精力", flavor: "管理时间的第一步是买一本书。" },
  ...
  { id: "ge5", type: "growth", growthType: "efficiency", growthLabel: "效率", title: "收件箱清零", cost: 1, text: "效率；无即时效果", flavor: "未读归零，问题仍在。" },
  { id: "ge6", type: "growth", growthType: "efficiency", growthLabel: "效率", title: "批量处理", cost: 2, energy: 1, text: "效率；返还 1 精力", flavor: "一次犯同一种错误，比逐个犯更高效。" },
  ...
  { id: "gn5", type: "growth", growthType: "network", growthLabel: "人脉", title: "校友群", cost: 1, text: "人脉；无即时效果", flavor: "平时潜水，换工作时浮上来。" },
  { id: "gn6", type: "growth", growthType: "network", growthLabel: "人脉", title: "供应商朋友", cost: 2, suspicion: -1, performance: 1, text: "人脉；风险值 -1，+1 业绩", flavor: "关系到位，附件随后补。" },
  ...
  { id: "gh5", type: "growth", growthType: "health", growthLabel: "健康", title: "散步通勤", cost: 1, text: "健康；无即时效果", flavor: "多走十分钟，少想十分钟工作。" },
  { id: "gh6", type: "growth", growthType: "health", growthLabel: "健康", title: "年度体检", cost: 2, suspicion: -1, points: 1, text: "健康；风险值 -1，+1 分", flavor: "报告看不懂，但至少拿到了。" },
  ...
  { id: "gv4", type: "growth", growthType: "vision", growthLabel: "视野", title: "职业规划", cost: 2, points: 1, text: "视野；+1 分", flavor: "五年计划的第一步是先过周一。" },
  { id: "gv5", type: "growth", growthType: "vision", growthLabel: "视野", title: "趋势报告", cost: 1, text: "视野；无即时效果", flavor: "预测很多，兑现另说。" },
  { id: "gv6", type: "growth", growthType: "vision", growthLabel: "视野", title: "跨界课程", cost: 2, performance: 1, text: "视野；+1 业绩", flavor: "至少学会了另一套黑话。" },
];
...
export const RISK_CARDS = BASE_RISK_CARDS.flatMap((card) => [0, 1, 2, 3, 4].map((copy) => ({
  ...card,
  id: `${card.id}-${copy}`,
})));
